...
export class News extends Component {
    ...
    async newsUpdate(){
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a359e80665d843c1afb06e4f26581989&page=${this.state.page}&pageSize=${this.props.pageSize}`;
        this.setState({
            loading: true
        });
